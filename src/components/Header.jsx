...
import vkshop from '../image/sp2.png';
...
<header className="bg-[#F5A4F1] text-white py-1 ">
        ...
        <div className="mx-auto flex justify-between items-center ">
          ...
          <nav>
            <ul className="flex space-x-4 mr-4 max-[400px]:space-x-1 mr-2">
              <li><Link to='/'className="  hover:bg-[#EA84E5] p-2 rounded-lg text-lg font-semibold "> Home</Link></li>
    ...
    {/* <li>
              ...
              <li> <Avatar  onClick={toggleDrawer}
      ...
      <aside
        className={`fixed top-0 right-0 w-64 bg-white text-gray-700 min-h-screen rounded-lg shadow-lg transform  z-10  ${
